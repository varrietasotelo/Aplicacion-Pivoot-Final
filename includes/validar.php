...
<body>
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Usuario o contraseña incorrecta</strong> usted a ingresado un usuario o
            ...
            <div class="container m-5 ">
                <div class="row">
                    <div class="col-6 p-0 d-flex">
                        <img class="ms-auto" src="../Imagenes/fondolog.jpg" alt="Jugador Basquet" height="590vh"
                            width="532vh">
                    </div>
                            ...
                            <form id="form" class="row g-3" action="../includes/validar.php" method="post">
                                ...
                                <div class="col-12 mt-4">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="password"
                                        id="password" placeholder="Escribe tu Contraseña" required>
                                </div>
                                ...
                                <div class="d-grid gap-2 col-12 mt-4">
                                    <button id="boton" type="submit"
                                        class="btn btn-warning border rounded-pill "><b>Ingresa</b>
                                    </button>
                                </div>

                                <div class="col-10 mt-3">
                                    <p>No tienes una cuenta, da click <a href="../html/registrar.html">Aqui</a></p>
                                    <p>¿Has olvidado tu contraseña? da click <a
                                            href="../html/recuperarcontraseña.html">Aqui</a></p>
                                </div>
                            </form>
                        </div>
